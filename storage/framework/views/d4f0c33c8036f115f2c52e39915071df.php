    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div x-data="{ activeTab: 'offline' }" class="w-full">
            ...
            <div x-show="activeTab === 'offline'" class="rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow" x-transition>
                <img src="<?php echo e(asset('images/tm1.png')); ?>" alt="Bootcamp Offline - 2 Days" class="w-full h-auto">
            </div>
            ...
            <div x-show="activeTab === 'online'" class="rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow" x-transition>
                <img src="<?php echo e(asset('images/tm2.png')); ?>" alt="Online Mentoring - 1 Month" class="w-full h-auto">
            </div>
        </div>
    </div>
</div>
...
<?php /**PATH C:\Users\HP\Documents\meapro\mea\resources\views/components/event-details.blade.php ENDPATH**/ ?>