<?php $__env->startSection('title', 'MEA 2026'); ?>

<?php $__env->startSection('body-class', 'hero-active'); ?>
...
<section class="relative z-0 min-h-screen bg-transparent overflow-hidden isolate" id="home">
    ...
    <div class="hero-support-group">
        ...
        <div class="hero-support-logos">
            <img src="<?php echo e(asset('images/logo_pnmpeduli.svg')); ?>" alt="PNM Peduli">
            <img src="<?php echo e(asset('images/logo_asia.svg')); ?>" alt="Institut Asia">
            <img src="<?php echo e(asset('images/logo_inbis.svg')); ?>" alt="INBIS">
        </div>
    </div>
</section>
...
<style>
    #home {
        ...
        background-image: url("<?php echo e(asset('images/bg_new.svg')); ?>");
    ...
    @media (max-width: 640px) {
        ...
        #home {
            ...
            background-image: url("<?php echo e(asset('images/bg_mobile.svg')); ?>") !important;
...
<?php echo $__env->make('components.event-details', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

<?php echo $__env->make('partials.announcement', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\HP\Documents\meapro\mea\resources\views/home.blade.php ENDPATH**/ ?>