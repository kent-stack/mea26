...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'MEA 2026'); ?></title>
    <link rel="icon" type="image/jpeg" href="<?php echo e(asset('images/logo_mea.jpg')); ?>">
    ...
    margin-top: clamp(2rem, 5vw, 3rem);
        ...
        @media (max-width: 640px) {
            ...
            #home {
                ...
                background-image: url("<?php echo e(asset('images/bg_new.svg')); ?>") !important;
...
<body class="<?php echo $__env->yieldContent('body-class',''); ?> bg-slate-50 flex flex-col min-h-screen font-sans">
    <div class="content-wrapper">
        <?php if(!in_array(Route::currentRouteName(), ['login', 'register', 'login.perform', 'forgot-password', 'reset-password'])): ?>
...
<?php endif; ?>
        ...
        <div class="mx-auto max-w-6xl px-4 py-10 sm:px-6 lg:px-8">
            ...
            <div class="text-center text-xs text-slate-400 sm:text-sm">
                Copyright © <?php echo e(date('Y')); ?> Inkubator Bisnis Institut Asia
            </div>
        </div>
        </footer>
    </div>
    ...
    </script><?php /**PATH C:\Users\HP\Documents\meapro\mea\resources\views/layouts/app.blade.php ENDPATH**/ ?>